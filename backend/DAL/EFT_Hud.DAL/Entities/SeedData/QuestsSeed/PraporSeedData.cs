...
namespace EFT_Hud.DAL.Entities.SeedData.QuestsSeed
{
    class PraporSeedData
    {
        ...
        public static readonly Quest[] Quests = {
            ...
            new Quest  { Id = Ids.Checking, Name = "Checking", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Shootout_picnic, Name = "Shootout picnic", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Delivery_from_the_past, Name = "Delivery from the past", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.BP_Depot, Name = "BP Depot", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Bad_rep_evidence, Name = "Bad rep evidence", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Ice_cream_cone, Name = "Ice cream cones", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Postman_part_part_1, Name = "Postman part - part 1", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Shaking_up_teller, Name = "Shaking up teller", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_1, Name = "The Punisher - part 1", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_2, Name = "The Punisher - part 2", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_3, Name = "The Punisher - part 3", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_4, Name = "The Punisher - part 4", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_5, Name = "The Punisher - part 5", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.The_Punisher_part_6, Name = "The Punisher - part 6", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Polikhim_hobo, Name = "Polikhim hobo", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Big_customer, Name = "Big customer", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.No_offence, Name = "No offence", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Grenadier, Name = "Grenadier", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Perfect_mediator, Name = "Perfect mediator", MerchantId = MerchantsSeedData.Ids.Prapor, Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Insomnia, Name = "Insomnia", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Test_drive_Part_1, Name = "Test drive - Part 1", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
            new Quest  { Id = Ids.Regulated_materials, Name = "Regulated materials", MerchantId = MerchantsSeedData.Ids.Prapor,Status = ObjectiveStatus.New},
        };
        ...
        public static readonly Objective[] Objectives =
        {
            ...
            new Objective {Id = 39, QuestId = Ids.Bad_rep_evidence, Count = 1, CountDone = 0, Type = ObjectiveType.Find, ItemId = 29, LocationId = LocationsSeedData.Ids.Customs},
            new Objective {Id = 40, QuestId = Ids.Bad_rep_evidence, Count = 1, CountDone = 0, Type = ObjectiveType.Discover, Description = "Gain access to the closed room in offices", Optional = true, LocationId = LocationsSeedData.Ids.Factory},
            new Objective {Id = 41, QuestId = Ids.Bad_rep_evidence, Count = 1, CountDone = 0, Type = ObjectiveType.Find, ItemId = ItemsSeedData.Ids.Key_Portable_cabin_key_of_customs_Factory_zone , Optional = true, LocationId = LocationsSeedData.Ids.Factory},
            new Objective {Id = 42, QuestId = Ids.Bad_rep_evidence, Count = 1, CountDone = 0, Type = ObjectiveType.Handover, ItemId = 29, LocationId = LocationsSeedData.Ids.Customs},
            new Objective {Id = 43, QuestId = Ids.Bad_rep_evidence, Count = 1, CountDone = 0, Type = ObjectiveType.Exit, LocationId = LocationsSeedData.Ids.Customs},

            new Objective {Id = 44, QuestId = Ids.Ice_cream_cone, Count = 6, Type = ObjectiveType.Find, ItemId = 32},
            new Objective {Id = 45, QuestId = Ids.Ice_cream_cone, Count = 1, Type = ObjectiveType.Find, LocationId = LocationsSeedData.Ids.Customs, ItemId = ItemsSeedData.Ids.Key_ZB_014},
            new Objective {Id = 46, QuestId = Ids.Ice_cream_cone, Count = 1, Type = ObjectiveType.Discover, LocationId = LocationsSeedData.Ids.Woods, Description = "Locate the right bunker"},
            new Objective {Id = 47, QuestId = Ids.Ice_cream_cone, Count = 6, Type = ObjectiveType.Handover, ItemId = 32},

            new Objective {Id = 48, QuestId = Ids.Postman_part_part_1, Count = 1, Type = ObjectiveType.Find, ItemId = 33, LocationId = LocationsSeedData.Ids.Factory},
            new Objective {Id = 49, QuestId = Ids.Postman_part_part_1, Count = 1, Type = ObjectiveType.Exit, LocationId = LocationsSeedData.Ids.Factory},
            new Objective {Id = 50, QuestId = Ids.Postman_part_part_1, Count = 1, Type = ObjectiveType.Handover, ItemId = 33},
